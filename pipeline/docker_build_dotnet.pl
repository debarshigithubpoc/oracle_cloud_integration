...
dockerPipelineTemplate('development', 'Applications/DotnetDocker/dotnethelloworld', 'dotnet', 'linux', 'dockerRegistry', 'dockerUsername', 'dockerPassword', 'dotnethellorelease', './dotnethelloworld/')
