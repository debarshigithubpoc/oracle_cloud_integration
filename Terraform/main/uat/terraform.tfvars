oci_core_vcns_var = {
  vcn1 = {
    ...
    display_name = "vcn-uat-001"
  }
  vcn2 = {
    cidr_block   = "10.20.0.0/16"
    display_name = "vcn-uat-002"
  }
}
...
network_security_group_var = {
  nsg1 = {
    network_security_group = {
      display_name     = "vcn-uat-001-nsg-001"
      vcn_display_name = "vcn-uat-001"
    }
    nsg_rules = {
      rule1 = {
...
oci_core_subnets_var = {
  subnet1 = {
    ...
    display_name     = "vcn-uat-001-snet-001"
    vcn_display_name = "vcn-uat-001"
  }
  subnet2 = {
    cidr_block       = "10.10.2.0/24"
    display_name     = "vcn-uat-001-snet-002"
    vcn_display_name = "vcn-uat-001"
  }
  subnet3 = {
    cidr_block       = "10.10.3.0/24"
    display_name     = "vcn-uat-001-snet-003"
    vcn_display_name = "vcn-uat-001"
  }
}
...
instances = {
  instance1 = {
    ...
    vcn_display_name         = "vcn-uat-001"
    subnet_display_name      = "vcn-uat-001-snet-001"
...
oci_containerengine_clusters_var = {
  cluster1 = {
    ...
    name                = "kub-uat-001"
    vcn_display_name    = "vcn-uat-001"
    subnet_display_name = "vcn-uat-001-snet-002"
