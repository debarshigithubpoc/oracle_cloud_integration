...
route_tables_var = {
  route_table_1 = {
    display_name     = "oke-k8sprod-private-routetable"
    vcn_display_name = "oke-k8sprod-vcn-vnet"
  ...
  route_table_2 = {
    display_name     = "oke-k8sprod-public-routetable"
    vcn_display_name = "oke-k8sprod-vcn-vnet"
    ...
    route_rules = [
      {
        ...
        internet_gateway_display_name = "oke-k8sprod-igw"
...
oci_containerengine_clusters_var = {
  quick-cluster1 = {
    name                = "oke-k8sprod-cluster1"
    kubernetes_version  = "v1.31.1"
    vcn_display_name    = "oke-k8sprod-vcn-vnet"
    subnet_display_name = "oke-k8sprod-ApiEndpoint-subnet"
...
instances = {
  instance1 = {
    ...
    ssh_authorized_keys_path = "C:/jenkins_workspace/oracle_cloud_integration/Terraform/main/prod/public_key/id_rsa.pub"
  }
}
